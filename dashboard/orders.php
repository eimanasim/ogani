                                ...
                                <div class="card stats-card">
                                    <div class="card-body p-3 p-lg-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <p class="h6 mb-0 text-muted">Shipped</p>
                                                <div class="h3 mb-0" aria-live="polite"><span x-text="stats.shipped"></span></div>
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex gap-2">
                                            ...
                                            <div class="position-relative">
                                                <input type="search" class="form-control form-control-sm" placeholder="Search orders..." x-model="searchQuery" @input="filterOrders()" style="width: 200px;">
                                            ...
                                            <!-- Date Range -->
                                            <select class="form-select form-select-sm" x-model="dateFilter" @change="filterOrders()" style="width: 150px;">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                <th style="width: 40px;">
                                                    <input type="checkbox" class="form-check-input" @change="toggleAll($event.target.checked)" :checked="selectedOrders.length === filteredOrders.length && filteredOrders.length > 0">
                                                </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="order-customer">
                                                            <img :src="order.customer.avatar" class="customer-avatar" :alt="order.customer.name" loading="lazy" decoding="async">
                                                            <div>
